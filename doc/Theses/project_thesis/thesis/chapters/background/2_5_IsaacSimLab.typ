// §2.5 NVIDIA Isaac Sim and Isaac~Lab
...
#faps-figure(
  isaac-stack(),
  caption: [Schematic view of the software stack used in this thesis. Isaac~Sim is built on Omniverse Kit with #ac("USD") as the scene data layer and PhysX~5 as the physics backend. Isaac~Lab provides task abstractions (manager-based #ac("MDP") environments) and training utilities on top.],
  short-caption: [Isaac Sim and Isaac~Lab software stack],
...
#faps-table(
  table(
    ...
    [Isaac Sim + Isaac~Lab], [Integrated Omniverse stack: PhysX, RTX, #ac("RL") tooling~@nvidia_isaac_sim_510_what_is @Mittal2025IsaacLab], [High],
