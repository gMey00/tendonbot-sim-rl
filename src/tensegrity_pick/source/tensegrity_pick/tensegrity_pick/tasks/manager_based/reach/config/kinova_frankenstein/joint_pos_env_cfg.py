...
from tensegrity_pick.robots.kinova_frankenstein_robot_cfg import KINOVA_FRANKENSTEIN_GRIPPER_CFG, CONTROLLED_JOINT_NAMES
...
@configclass
class KinovaFrankensteinReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        configure_f140_reach(
            self,
            KINOVA_FRANKENSTEIN_GRIPPER_CFG,
...
@configclass
class KinovaFrankensteinReachEnvCfg_PLAY(KinovaFrankensteinReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
