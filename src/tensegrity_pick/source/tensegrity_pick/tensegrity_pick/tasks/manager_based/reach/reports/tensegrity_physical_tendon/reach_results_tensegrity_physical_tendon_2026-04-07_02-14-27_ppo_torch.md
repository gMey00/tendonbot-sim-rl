...
| Run ID | `2026-04-07_02-14-27_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -0.9694 |
| Position tracking reward | -0.0423 |
| Orientation tracking reward | -0.0713 |
| Position fine-grained reward | 0.046403 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.003825 |
| Joint velocity penalty | -0.009786 |
| Policy std deviation | 0.1079 |
| Learning rate (final) | 1.32e-04 |
