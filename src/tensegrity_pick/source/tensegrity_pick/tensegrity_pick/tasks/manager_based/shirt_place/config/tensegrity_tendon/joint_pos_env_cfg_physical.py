"""Tensegrity *physical* tendon-driven shirt-placement environment configs.
...
from tensegrity_pick.tasks.manager_based.shirt_place import mdp
from tensegrity_pick.tasks.manager_based.shirt_place.mdp import rewards as task_rew
from tensegrity_pick.tasks.manager_based.shirt_place.config.tensegrity.joint_pos_env_cfg import (
    TensegrityShirtPlaceEnvCfg,
    GRASP_BODIES,
    BASE_JOINT_NAMES,
    EE_LINK,
)
...
class PhysicalTendonObservationsCfg:
    ...
    Identical structure to shirt_place but with physical joint names."""
...
@configclass
class TensegrityShirtPlacePhysicalTendonEnvCfg(TensegrityShirtPlaceEnvCfg):
    """Tensegrity shirt-place task driven by physical body-force tendons.
...
@configclass
class TensegrityShirtPlacePhysicalTendonEnvCfg_PLAY(TensegrityShirtPlacePhysicalTendonEnvCfg):
