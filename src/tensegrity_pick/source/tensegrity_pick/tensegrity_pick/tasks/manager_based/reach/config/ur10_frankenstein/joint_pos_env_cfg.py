...
from tensegrity_pick.robots.ur10_frankenstein_robot_cfg import UR10_FRANKENSTEIN_GRIPPER_CFG, CONTROLLED_JOINT_NAMES
...
@configclass
class UR10FrankensteinReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        configure_f140_reach(
            self,
            UR10_FRANKENSTEIN_GRIPPER_CFG,
...
@configclass
class UR10FrankensteinReachEnvCfg_PLAY(UR10FrankensteinReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
