...
|---|---|
| Variant | `tensegrity` |
| Run ID | `2026-03-30_00-47-46_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | 0.5236 |
| Position tracking reward | -0.0081 |
| Orientation tracking reward | -0.0235 |
| Position fine-grained reward | 0.077451 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.000957 |
| Joint velocity penalty | -0.001157 |
| Policy std deviation | 0.0548 |
| Learning rate (final) | 3.33e-04 |
