...
| Run ID | `2026-04-07_00-16-30_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -1.4363 |
| Position tracking reward | -0.0494 |
| Orientation tracking reward | -0.0788 |
| Position fine-grained reward | 0.019559 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.004472 |
| Joint velocity penalty | -0.009121 |
| Policy std deviation | 0.1335 |
| Learning rate (final) | 1.74e-04 |
