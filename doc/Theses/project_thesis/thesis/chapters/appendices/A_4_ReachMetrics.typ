...
This appendix provides complete training curves for the reach task across all three tensegrity variants. All plots are cut at 48k timesteps (#ac("PD") variant training duration). Figures are generated by `project_thesis/scripts/plot_appendix_reach.py`; rerun with `make appendix-reach` from `project_thesis/scripts/`.
