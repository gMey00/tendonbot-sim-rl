...
| Run ID | `2026-04-08_23-32-28_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -0.4425 |
| Position tracking reward | -0.0229 |
| Orientation tracking reward | -0.0409 |
| Position fine-grained reward | 0.042737 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.003017 |
| Joint velocity penalty | -0.002625 |
| Policy std deviation | 0.1120 |
| Learning rate (final) | 2.26e-04 |
