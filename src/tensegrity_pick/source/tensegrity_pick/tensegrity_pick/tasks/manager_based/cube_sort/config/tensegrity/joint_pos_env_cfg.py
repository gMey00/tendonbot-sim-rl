...
"""Tensegrity PD-driven cube-sorting environment configurations.

Inherits from the robot-agnostic ``CubeSortEnvCfg`` and fills in:
...
from tensegrity_pick.tasks.manager_based.cube_sort.cube_sort_env_cfg import CubeSortEnvCfg
...
@configclass
class TensegrityCubeSortEnvCfg(CubeSortEnvCfg):
    """Tensegrity 5-DOF PD cube-sorting task."""
    ...
    def __post_init__(self) -> None:
        ...
        self.scene.robot = TENS_5DOF_GRIPPER_CFG.replace(
            ...
            init_state=ArticulationCfg.InitialStateCfg(
                ...
                joint_pos=_SORT_INITIAL_JOINT_POS,
            ),
        )
