...
| Run ID | `2026-03-31_08-38-05_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | 0.6355 |
| Position tracking reward | -0.0072 |
| Orientation tracking reward | -0.0115 |
| Position fine-grained reward | 0.078880 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.003612 |
| Joint velocity penalty | -0.002681 |
| Policy std deviation | 0.0537 |
| Learning rate (final) | 2.28e-04 |
