...
from . import mdp
from .shirt_place_scene_cfg import ShirtPlaceSceneCfg, CONVEYOR_SURFACE_HEIGHT_M
...
class ShirtPlaceEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: ShirtPlaceSceneCfg = ShirtPlaceSceneCfg(num_envs=8192, env_spacing=5.0)
