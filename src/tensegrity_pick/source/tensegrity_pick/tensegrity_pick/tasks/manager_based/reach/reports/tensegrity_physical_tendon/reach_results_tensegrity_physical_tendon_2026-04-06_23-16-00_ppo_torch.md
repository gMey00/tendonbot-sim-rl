...
| Run ID | `2026-04-06_23-16-00_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -1.6068 |
| Position tracking reward | -0.0524 |
| Orientation tracking reward | -0.0862 |
| Position fine-grained reward | 0.024938 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.003348 |
| Joint velocity penalty | -0.013511 |
| Policy std deviation | 0.1414 |
| Learning rate (final) | 2.73e-04 |
