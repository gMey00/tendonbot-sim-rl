...
| Devlin2012 | Devlin, S. & Kudenko, D. | "Dynamic Potential-Based Reward Shaping" | 2012 | 🟡 | 🟢 | 🟢 | Time-dependent potentials and latch-based rewards preserving policy invariance. Extends Ng (1999) to non-stationary settings. |
| Wiewiora2003 | Wiewiora, E., Cottrell, G. W. & Elkan, C. | "Principled Methods for Advising Reinforcement Learning Agents" | 2003 | 🔴 | 🟡 | 🟢 | State-action potentials and Q-value initialization equivalence. Theoretical background for reward shaping. |
| Andrychowicz2017 | Andrychowicz, M., Wolski, F., Ray, A. et al. | "Hindsight Experience Replay" | 2017 | 🟡 | 🟢 | 🟢 | Goal relabeling for sparse binary rewards. HER philosophy: relabel failed trajectories as successes for alternative goals. |
| Berducci2024 | Berducci, L. et al. | "Hierarchical Potential-Based Reward Shaping" | 2024 | 🟡 | 🟢 | 🟢 | Compositional potentials with strict partial ordering for multi-requirement task decomposition. |

### Reward Machines

| Ref | Authors | Title | Year | Impl. | Thesis | Cred. | Summary |
|-----|---------|-------|------|-------|--------|-------|---------|
| ToroIcarte2022 | Toro Icarte, R., Klassen, T. Q., Valenzano, R. A. & McIlraith, S. A. | "Reward Machines: Exploiting Reward Function Structure in Reinforcement Learning" | 2022 | 🟡 | 🟢 | 🟢 | Formal RM framework (δ_u, δ_r) with four solution algorithms (QRM, CRM, HRM). Core reference for structured reward decomposition. |
| ToroIcarte2018 | Toro Icarte, R., Klassen, T. Q., Valenzano, R. A. & McIlraith, S. A. | "Using Reward Machines for High-Level Task Specification and Decomposition in Reinforcement Learning" | 2018 | 🟡 | 🟢 | 🟢 | Original RM paper: finite-state automata for task phase decomposition with distinct reward functions per phase. |
| Camacho2021 | Camacho, A., Varley, J., Zeng, A., Jain, D., Iscen, A. & Kalashnikov, D. | "Reward Machines for Vision-Based Robotic Manipulation" | 2021 | 🟡 | 🟡 | 🟢 | DQRM on UR5 PyBullet achieving 6× fewer training steps vs. DQN. Demonstrates RM applicability to robotic manipulation. |
...
| Ref | Authors | Title | Year | Impl. | Thesis | Cred. | Summary |
|-----|---------|-------|------|-------|--------|-------|---------|
| VanSeijen2017 | Van Seijen, H., Fatemi, M., Romoff, J., Laroche, R., Barnes, T. & Tsang, J. | "Hybrid Reward Architecture for Reinforcement Learning" | 2017 | 🟡 | 🟢 | 🟢 | Decomposed rewards with separate value functions per reward component. Theoretical basis for multi-term reward structures. |
| Mu2024 | Mu, T., Liu, M. & Su, H. | "DrS: Learning Reusable Dense Rewards for Multi-Stage Tasks" | 2024 | 🟡 | 🟡 | 🟢 | Discriminator-based stage rewards evaluated on ManiSkill. Learned dense rewards for sequential manipulation. |
...
| Zhu2020robosuite | Zhu, Y. et al. | "robosuite: A Modular Simulation Framework and Benchmark for Robot Learning" | 2020 | 🔴 | 🟡 | 🟢 | Explicit `staged_rewards()` method with max-aggregation across phases. Key manipulation benchmark with structured reward API. |
| Yu2019metaworld | Yu, T., Quillen, D., He, Z., Julian, R., Hausman, K., Finn, C. & Levine, S. | "Meta-World: A Benchmark and Evaluation for Multi-Task and Meta Reinforcement Learning" | 2019 | 🔴 | 🟡 | 🟢 | 50-task benchmark with additive R_reach + R_grasp + R_place reward composition. Context for staged reward design. |
| Gu2023maniskill2 | Gu, J., Xiang, F., Li, X. et al. | "ManiSkill2: A Unified Benchmark for Generalizable Manipulation Skills" | 2023 | 🟡 | 🟡 | 🟢 | GPU-accelerated benchmark with per-task `compute_dense_reward()` and multi-stage structure. |
| Plappert2018 | Plappert, M. et al. | "Multi-Goal Reinforcement Learning: Challenging Robotics Environments and Request for Research" | 2018 | 🔴 | 🟡 | 🟢 | Gymnasium Robotics sparse binary rewards with HER focus. Baseline for goal-conditioned manipulation. |
