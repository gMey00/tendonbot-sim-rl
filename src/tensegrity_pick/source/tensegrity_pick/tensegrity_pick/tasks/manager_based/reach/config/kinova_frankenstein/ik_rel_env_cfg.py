...
@configclass
class KinovaFrankensteinIKRelReachEnvCfg(KinovaFrankensteinReachEnvCfg):
...
@configclass
class KinovaFrankensteinIKRelReachEnvCfg_PLAY(KinovaFrankensteinIKRelReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
