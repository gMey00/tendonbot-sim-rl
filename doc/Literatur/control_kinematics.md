...
| Ref | Authors | Title | Year | Impl. | Thesis | Cred. | Summary |
|-----|---------|-------|------|-------|--------|-------|---------|
| [Bicchi2004](sources/control_kinematics/Journal_Articles/Bicchi2004.pdf) | Bicchi, A. & Tonietti, G. | "Fast and 'Soft-Arm' Tactics: Safety-Performance Tradeoff in Robot Arms" | 2004 | 🔴 | 🟢 | 🟢 | Safety-performance tradeoff in compliant robot arms. Motivation for the tensegrity approach's inherent compliance. [DOI](https://doi.org/10.1109/MRA.2004.1310939) |
| [Salisbury1982](sources/control_kinematics/Journal_Articles/Salisbury1982.pdf) | Salisbury, J. K. & Craig, J. J. | "Articulated Hands: Force Control and Kinematic Issues" | 1982 | 🔴 | 🟡 | 🟢 | Foundational work on force control in articulated hands. Historical context for tendon-driven force control. [DOI](https://doi.org/10.1177/027836498200100102) |
| [Lee1988](sources/control_kinematics/Journal_Articles/Lee1988.pdf) | Lee, J. J. & Tsai, L.-W. | "The Structural Synthesis of Tendon-Driven Manipulators Having a Pseudotriangular Structure Matrix" | 1988 | 🟡 | 🟢 | 🟢 | Generalized-coordinate Jacobian for tendon-driven systems. Establishes the pseudotriangular structure matrix concept. |
| [Kobayashi1998](sources/control_kinematics/Journal_Articles/Kobayashi1998.pdf) | Kobayashi, H. et al. | "Tendon-driven Robot Arm with Jacobian-Transpose Control" | 1998 | 🟡 | 🟢 | 🟢 | Jacobian-transpose control for tendon-driven arms. Directly relevant to the project's tendon force mapping approach. |
...
| Ref | Authors | Title | Year | Impl. | Thesis | Cred. | Summary |
|-----|---------|-------|------|-------|--------|-------|---------|
| [Reis2015](sources/control_kinematics/Conference_Papers/Reis2015.pdf) | Reis, M. et al. | "Modeling and Control of a Multifingered Robot Hand for Object Grasping and Manipulation Tasks" | 2015 | 🔴 | 🟡 | 🟢 | Multifingered hand control. Background for tendon-driven grasping mechanics. [DOI](https://doi.org/10.1109/CDC.2015.7402102) |
...
| Ref | Authors | Title | Year | Impl. | Thesis | Cred. | Summary |
|-----|---------|-------|------|-------|--------|-------|---------|
| [Macenski2022ROS2](sources/control_kinematics/Journal_Articles/Macenski2022ROS2.pdf) | Macenski, S. et al. | "Robot Operating System 2: Design, Architecture, and Uses in the Wild" | 2022 | 🟢 | 🟢 | 🟢 | Reference description of ROS 2 architecture. Cited as the runtime environment for the manipulator's control stack. [DOI](https://doi.org/10.1126/scirobotics.abm6074) |
| [Qu2024HighPrecise](sources/control_kinematics/Journal_Articles/Qu2024HighPrecise.pdf) | Qu, S. et al. | "High-Precise Robot Arm Manipulation Based on Online Iterative Learning and Forward Simulation with Positioning Error Below End-Effector Physical Minimum Displacement" | 2024 | 🟡 | 🟡 | 🟡 | Iterative-learning controller with simulation-in-the-loop for sub-mm positioning error. Reference for high-precision arm control. [arXiv](https://arxiv.org/abs/2403.03778) |
| [VillaTiburcio2024](sources/control_kinematics/Journal_Articles/VillaTiburcio2024.pdf) | Villa-Tiburcio, A. et al. | "ANN Enhanced Hybrid Force/Position Controller of Robot Manipulators for Fiber Placement" | 2024 | 🔴 | 🟡 | 🟢 | Neural-network-augmented hybrid force/position control. Comparator for force-controlled tendon manipulator. [DOI](https://doi.org/10.3390/robotics13070105) |
