...
This chapter reviews prior work along three dimensions that converge in the present thesis: (i)~#acl("RL")-based manipulation in #ac("GPU")-accelerated simulators, (ii)~simulation and control of tendon- and cable-driven robots, (iii)~tensegrity-inspired and linkage-based robot design. The review focuses on contributions that directly inform the methodological choices made in this thesis and concludes by identifying the specific gap that the present work addresses.
...
Walter _et~al._~@Walter2023Tensegrity introduced the cable-driven tensegrity manipulator used in this thesis and demonstrated 83% impact force isolation in hardware experiments. Klein~@Klein2023 established the initial workspace analysis and Gazebo simulation model for this robot but did not employ learning-based control.
