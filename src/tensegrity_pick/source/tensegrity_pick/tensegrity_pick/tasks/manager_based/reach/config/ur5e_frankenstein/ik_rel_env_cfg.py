...
from .joint_pos_env_cfg import UR5eFrankensteinReachEnvCfg
...
@configclass
class UR5eFrankensteinIKRelReachEnvCfg(UR5eFrankensteinReachEnvCfg):
...
@configclass
class UR5eFrankensteinIKRelReachEnvCfg_PLAY(UR5eFrankensteinIKRelReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
