...
| Run ID | `2026-04-06_23-44-19_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -0.7138 |
| Position tracking reward | -0.0336 |
| Orientation tracking reward | -0.0560 |
| Position fine-grained reward | 0.045182 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.003813 |
| Joint velocity penalty | -0.010202 |
| Policy std deviation | 0.1203 |
| Learning rate (final) | 1.69e-04 |
