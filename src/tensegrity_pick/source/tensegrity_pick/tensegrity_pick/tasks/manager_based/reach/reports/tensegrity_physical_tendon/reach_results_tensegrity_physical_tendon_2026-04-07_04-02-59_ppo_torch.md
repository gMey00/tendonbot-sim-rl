...
| Run ID | `2026-04-07_04-02-59_ppo_torch` |

## Converged Metrics (last 10% of training)

| Metric | Value |
|---|---|
| Total episode reward (mean) | -0.8360 |
| Position tracking reward | -0.0424 |
| Orientation tracking reward | -0.0613 |
| Position fine-grained reward | 0.054659 |
| Position reached (< 5cm) | 0.0000 |
| Orientation reached (< 0.3 rad) | 0.0000 |
| Pose reached (both) | 0.0000 |
| Action rate penalty | -0.010910 |
| Joint velocity penalty | -0.009012 |
| Policy std deviation | 0.0704 |
