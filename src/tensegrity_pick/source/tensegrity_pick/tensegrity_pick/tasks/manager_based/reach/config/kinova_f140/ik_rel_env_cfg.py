...
from .joint_pos_env_cfg import KinovaF140ReachEnvCfg
...
@configclass
class KinovaF140IKRelReachEnvCfg(KinovaF140ReachEnvCfg):
...
@configclass
class KinovaF140IKRelReachEnvCfg_PLAY(KinovaF140IKRelReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
