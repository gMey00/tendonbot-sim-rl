...
\usepackage[german,english]{babel} 	% Sprachpaket (English main, German available)
...
% fdsymbol provides extra symbols but replaces the math symbol font,
% which turns \nabla into a fat dot.  Restore from the original CM font.
\usepackage{fdsymbol}
\DeclareSymbolFont{CMsymbols}{OMS}{cmsy}{m}{n}
\DeclareMathSymbol{\nabla}{\mathord}{CMsymbols}{"72}
...
% Acronyms / abbreviations and symbol list
% (replaces the former nomencl/makeidx workflow)
\usepackage{xparse}
\usepackage{acro}
