"""Tensegrity PD-driven shirt-placement environment configurations.

Inherits from the robot-agnostic ``ShirtPlaceEnvCfg`` and fills in:
...
from tensegrity_pick.tasks.manager_based.shirt_place.shirt_place_env_cfg import (
    ShirtPlaceEnvCfg,
    ShirtPlaceEnvCfg_PLAY,
)
...
@configclass
class TensegrityShirtPlaceEnvCfg(ShirtPlaceEnvCfg):
    """Tensegrity 5-DOF PD shirt-placement task."""
...
@configclass
class TensegrityShirtPlaceEnvCfg_PLAY(TensegrityShirtPlaceEnvCfg):
