...
The arm architecture examined in this thesis was physically introduced by Walter _et~al._, who demonstrated the wrists compliance through hardware experiments isolating impact forces by up to 83%~@Walter2023Tensegrity. Klein developed the initial workspace analysis and a simulation model for this manipulator but did not apply learning-based control~@Klein2023.
