...
from tensegrity_pick.robots.ur5e_frankenstein_robot_cfg import UR5E_FRANKENSTEIN_GRIPPER_CFG, CONTROLLED_JOINT_NAMES
...
@configclass
class UR5eFrankensteinReachEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        configure_f140_reach(
            self,
            UR5E_FRANKENSTEIN_GRIPPER_CFG,
...
@configclass
class UR5eFrankensteinReachEnvCfg_PLAY(UR5eFrankensteinReachEnvCfg):
    def __post_init__(self):
        super().__post_init__()
